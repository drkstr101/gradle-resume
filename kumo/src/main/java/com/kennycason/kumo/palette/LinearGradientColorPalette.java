...
public class LinearGradientColorPalette extends ColorPalette {
   ...
   *                      color1 and color2
   */
  public LinearGradientColorPalette(final Color color1, final Color color2, final int gradientSteps) {
   ...
   * @param gradientStepsC1AndC2 number of colors to be generated between color1
   *                             and color2 this includes both color1 and color2
   * @param gradientStepsC2AndC3 number of colors to be generated between color2
   *                             and color3 this includes both color2 and color3
   */
  public LinearGradientColorPalette(final Color color1, final Color color2, final Color color3,
      final int gradientStepsC1AndC2, final int gradientStepsC2AndC3) {
    super(createTwoLinearGradients(color1, color2, color3, gradientStepsC1AndC2, gradientStepsC2AndC3));
  }

  private static List<Color> createTwoLinearGradients(final Color color1, final Color color2, final Color color3,
      final int gradientStepsC1AndC2, final int gradientStepsC2AndC3) {
   ...
   *                      color1 and color2, this includes both color1 and color2
