...
public class CollisionRasterTest {
  ...
  /**
   * this test ensures setting one pixel doen't affect another pixel and not other
   * line.
   */
  @Test
  ...
  public void collisionsAreFound() {
    ...
    Assert.assertFalse(checker.collide(collidable(new Point(30, 30), dimension, collisionRasterA),
        collidable(new Point(30, 30), dimension, collisionRasterB)));

    Assert.assertTrue(checker.collide(collidable(new Point(30, 30), dimension, collisionRasterA),
        collidable(new Point(20, 20), dimension, collisionRasterB)));

    Assert.assertFalse(checker.collide(collidable(new Point(20, 20), dimension, collisionRasterA),
        collidable(new Point(30, 30), dimension, collisionRasterB)));
  }
