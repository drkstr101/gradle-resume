 ...
 *
 * Diminishing returns on placement is primarily caused by WordCloud's method of
 * determining to re-place words in new locations. These results demonstrate the
 * R-Tree is faster than linear brute-force.
 *
