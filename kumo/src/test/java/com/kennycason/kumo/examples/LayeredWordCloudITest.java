...
public class LayeredWordCloudITest {
  ...
  public void layeredHaskellExample() throws IOException {
    ...
    layeredWordCloud.setColorPalette(0,
        new ColorPalette(new Color(0xFA6C07), new Color(0xFF7614), new Color(0xFF8936)));
    layeredWordCloud.setColorPalette(1,
        new ColorPalette(new Color(0x080706), new Color(0x3B3029), new Color(0x47362A)));
  ...
  public void layeredPhoBowl() throws IOException {
    ...
    layeredWordCloud.setColorPalette(0,
        new ColorPalette(new Color(0x26A621), new Color(0x21961D), new Color(0x187A15)));
    layeredWordCloud.setColorPalette(1,
        new ColorPalette(new Color(0x5963F0), new Color(0x515CF0), new Color(0x729FED)));
    layeredWordCloud.setColorPalette(2,
        new ColorPalette(new Color(0xEDC672), new Color(0xDBB258), new Color(0xDE7C1B)));
    layeredWordCloud.setColorPalette(3,
        new ColorPalette(new Color(0x70572B), new Color(0x857150), new Color(0xB09971)));
